...
class MaterialsTab(tk.Frame):
    ...
    def _build(self):
        ...
        concrete_fields = [
            ...
            ("fc_final (Pa):", self.app.v_fc_final),
            ("fc_initial (Pa):", self.app.v_fc_initial),
        ...
        pt_fields = [
            ...
            ("Eps (Pa):", self.app.v_pt_eps),
            ("Fse (Pa):", self.app.v_pt_fse),
            ("Fpy (Pa):", self.app.v_pt_fpy),
            ("Fpu (Pa):", self.app.v_pt_fpu),
    ...
    def get_concrete_spec(self) -> ConcreteSpec:
        ...
        return ConcreteSpec(
            name=self.app.v_conc_name.get() or "40 MPa",
            fc_final=fval(self.app.v_fc_final, 45e6),
            fc_initial=fval(self.app.v_fc_initial, 30e6),
    ...
    def get_pt_spec(self) -> PTSystemSpec:
        ...
        return PTSystemSpec(
            ...
            eps=fval(self.app.v_pt_eps, 195_000e6),
            fse=fval(self.app.v_pt_fse, 1_100e6),
            fpy=fval(self.app.v_pt_fpy, 1_564e6),
            fpu=fval(self.app.v_pt_fpu, 1_840e6),
