...
class MaterialsTab(tk.Frame):
    ...
    def get_pt_spec(self) -> PTSystemSpec:
        ...
        return PTSystemSpec(
            ...
            aps=fval(self.app.v_pt_aps, 100),
            ...
            duct_width=fval(self.app.v_pt_duct_w, 70),
            duct_height=fval(self.app.v_pt_duct_h, 35),
            ...
            seating_distance=fval(self.app.v_pt_seating_distance, 6),
